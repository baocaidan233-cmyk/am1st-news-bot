...
class NotionCandidateProps(BaseModel):
    ...
    want: str = "want"  # select — one of agents/want_tagger.py's WANTS, written at ingestion alongside topic. Stored rather than re-derived because every re-classification disagrees with the last by 7-13%, which makes two analyses of the same posts incomparable.
